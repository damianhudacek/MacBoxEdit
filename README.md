...
2. Open it and drag the application into the **Applications** folder.
3. **First Launch:** Since the app is not in the App Store, macOS will block it. **Right-click (Ctrl+click) -> Open** the app icon in your Applications folder and confirm the exception.
...
👉 **[Buy Me a Coffee](https://www.buymeacoffee.com/HudDan)**

---
*Created for the satellite enthusiast community.*
